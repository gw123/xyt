        ...
        'columns' => [
            ...
            ['attribute'=>'status',
              'value'=>function($model){
                    return common\utils\Constant::$VideoStatus[$model->status];
              }
            ],
            ['attribute'=>'auditStatus',
                'value'=>function($model){
                    return common\utils\Constant::$VideoAuditStatus[$model->auditStatus];
                }
            ],
           // 'status',
            ...
            // 'desc:ntext',
            // 'content',
            [ 'attribute'=>'updatedTime', 'value'=>function($model){ return date('Y-m-d h:i:s',$model->updatedTime); }],
