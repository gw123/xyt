...
<div class="article-index">
    ...
    <p> <?= Html::a('创建文章', ['create'], ['class' => 'btn btn-success']) ?> </p>
           ...
           // 'thumb',
            ...
            [
                ...
                'value'=>function($model){
                 return  common\utils\Constant::$ArticleStatus[$model->status];
                }
            ],
            // 'pv',
            // 'featured',
            ...
            [
                ...
                'label'=>'时间',
                'value'=>function($m){
                    return  date('Y-m-d' ,$m->createdTime);
                },
            ],
            // 'point',
