...
<div class="form-group field-article-point">
    ...
    echo Html::button($chapterStr?$chapterStr:'点击选择',['class'=>'btn btn-default chooserChapterBtn form-control' ]);
    echo Html::input('hidden',$name,$model->chapter);
    ?>
</div>
