...
<style>
    body {  font: 12px "\5B8B\4F53",san-serif; background-color: #2c2e2f }
        ...
        <div class="container">
            ...
            <div class=" topmenu topmenu_left">
                <ul id="menu-menu_left" class="dropdown">
                    <li  class="menu-item menu-item-type-custom menu-item-object-custom menu-item-348">
                        <a href="/index/chapter" hidefocus="true" style="outline: medium none;"><span>教材列表</span></a>
                    </li>
            ...
            <div class="topmenu topmenu_right>">
                <ul id="menu-menu_right" class="dropdown">
                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-348">
                        <a href="/index/article-index" hidefocus="true" style="outline: medium none;"><span>文章列表</span></a>
                    </li>
                    <li  class="menu-item menu-item-type-post_type menu-item-object-page menu-item-409">
                ...
                <div class="row navbar navbar-default">
                    <ul class="nav navbar-nav col-sm-12">
                        <?php foreach ($bookLvl1Category as $row){  ?>
                            <li class="col-xs-2"><a  href="/index/detal?id=<?=$row['id']?>"><?=$row['name']?></a></li>
                        <?php } ?>
                    </ul>
                </div>
                    ...
                    <div class="col-md-9 col-md-pull-3 row" style="padding-left: 4px;padding-right: 4px">
                        ...
                        foreach ($lvl2CategoryAndBooks  as $lvl1Category )
                        {
                            ...
                            foreach ($lvl2s as $lvl2Category)
                            {
                                ...
                                <div class="col-md-6 " >
                                    <ol class="breadcrumb">
                                        <li><a href="/index/chapter?category=<?=$lvl1Id?>"><?=$lvl1Title?></a></li>
                                        <li><a href="/index/chapter?category=<?=$lvl2Id?>"><?=$lvl2Title?></a></li>
                                        <a href="/index/chapter?category=<?=$lvl2Id?>" class="more">更多</a>
                                    </ol>
                                    <ul class="list-group">
                                        <?php  foreach ($books  as $book){ ?>
                                            <li class="list-group-item"> <a href="/index/detal?id=<?=$book['id']?>"><?=$book['title']?></a>  <span class="badge">书</span></li>
                                        <?php }?>
                                    </ul>
                                </div>
                            <?php } }  ?>
                        ...
                        <!--                   <div class="col-md-6 " >-->
                        <!--                       <ol class="breadcrumb">-->
                        <!--                           <li><a href="#">Ps入门教程</a></li>-->
                        <!--                           <li><a href="#">基础</a></li>-->
                        <!--                           <a href="#" class="more">更多</a>-->
                        <!--                       </ol>-->
                        <!--                       <ul class="list-group">-->
                        <!--                           <li class="list-group-item">免费域名注册  <span class="badge">新</span>  <span class="badge">精</span></li>-->
