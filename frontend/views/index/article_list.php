...
<div class="container clearfix">
    <div class="row" style="margin-bottom: 15px;margin-top: 10px;">
        <div class="col-xs-6 col-sm-8">
            <h3 class=" " style="color: #c88d27;">文章列表</h3>
        </div>
        <div class="col-xs-6 col-sm-4" style="text-align: right">
            <?=Html::beginForm('/index/article-list','get')?>
...
<!--列表-->
 <ul  class="row  row-list-box clearfix">
    <?php
    foreach ($lists as $item) {?>
        <li class="col-sm-4 col-xs-12 col-md-3">
            <div class="li-box">
                <h5 class="item-name" title="<?=$item['title']?>">
                    <a href="<?='/index/article-detail?id='.$item['id']  ?>"> <?=$item['title']?></a>
                </h5>
                <div class="item-about" title="<?=$item['desc']?>">
                    <a href="<?='/index/article-detail?id='.$item['id']  ?>">  <?=$item['desc']?> </a>
                </div>
