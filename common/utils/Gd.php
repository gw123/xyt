...
{
    throw  new Exception( '你没有安装GD库 ' );
}

class Image
{
    const   IMAGE_WATER_SOUTHEAST = 1;
    const   IMAGE_WATER_SOUTHWEST = 2;
    const   IMAGE_WATER_NORTHWEST = 3;
    const   IMAGE_WATER_NORTHEAST = 4;
    const   IMAGE_WATER_CENTER = 5;
    const   IMAGE_WATER_SOUTH = 6;
    const   IMAGE_WATER_NORTH = 7;
    const   IMAGE_WATER_WEST = 8;
    const   IMAGE_WATER_EAST  = 9;
...
class Gd{
    ...
    public function water($source, $locate = Image::IMAGE_WATER_SOUTHEAST,$alpha=80){
        ...
        if(!is_file($source)) throw new Exception('水印图像不存在 : '.$source);
